...
class Student:
    def __init__(self,root):
        ...
        img=Image.open("E:\\Facial Recognition\\college_images\\Student.jpg")
        ...
        course_combo = ttk.Combobox(currentcourse_frame,textvariable=self.var_course,
                                    ...
                                    width=17)
        course_combo["values"] = ("Select Courses", "FE", "TE", "SE", "BE")
        ...
        btn_frame.place(x=0, y=215, width=715, height=70)
        # save button
        ...
        # delete
        Search_btn = Button(btn_frame, text="Delete",command=self.delete_data, width=14,
                            font=('times new roman', 13, 'bold'), bg="blue",
                            fg="white")
        ...
        Take_photo_btn = Button(btn_frame1,command=self.generate_dataset, text="Take Photo Sample", width=30, font=('times new roman', 13, 'bold'),
                                bg="blue",
                                fg="white")
        Take_photo_btn.grid(row=1, column=0)
        Update_photo_btn = Button(btn_frame1, text="Update Photo Sample", width=30,
        ...
        Search_frame = LabelFrame(Right_frame, bd=2, bg="white", relief=RIDGE, text="Search System",
                                  font=("times new roman", 15, "bold"))
        Search_frame.place(x=5, y=12, width=710, height=70)
        ...
        Search_btn = Button(Search_frame, text="Search", width=7,
                            font=('times new roman', 12, 'bold'), bg="blue",
                            fg="white")
        Search_btn.grid(row=0, column=3, padx=4)
        ShowAll_btn = Button(Search_frame, text="Show All", width=7,
    ...
    def add_data(self):
        if self.var_dep.get() == "Select Department" or self.var_std_name.get() == "" or self.var_std_id.get() == "":
            ...
            try:
                conn = mysql.connector.connect(host="localhost", username="root", password="Aman7607",
